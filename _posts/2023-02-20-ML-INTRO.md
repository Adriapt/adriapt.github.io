...
But, what is $z$? $z$ is the value obtained when doing the linear regression explained on the other chapters: $$ f_{\rightharpoonup{w},b}(\rightharpoonup{x}) = \rightharpoonup{w} · \rightharpoonup{x} + b $$
